...
var joinQuer =
  "select products.item_id, products.product_name, departments.department_name, products.price, products.stock_quantity, products.product_sales from products inner join departments on products.department_name = departments.department_id";
  ...
  connection.query(
    ...
    (err, results, fields) => {
      if (err) {
        ...
        console.log(results.affectedRows + " songs updated\n");
      }
    }
  );
}
